      ...
      <div className="mb-5">
        ...
        <div className="relative w-full h-[70vh] bg-transparent flex items-center justify-center">
          <div className="w-[95%] h-[100%]  flex justify-end items-end">
            <div className="h-[100%] w-[80%] sm:w-[46%] lg:w-[35%]  text-gray-600 p-6 flex flex-col justify-end">
              <div className="w-full h-auto animate-fade-up4s">
                <h2 className="italic text-[1rem] lg:text-lg  border-gray-300 mb-6">
                  <span className="border-b-[2px] border-gray-400">Our</span>{" "}
                  Location
                </h2>
                <div className="mb-5 lg:mb-10">
                  <h1 className="text-[25px] lg:text-[40px] font-serif mb-4">
                    FLOWER STREET FAME
                  </h1>
                  <p className="mb-2 lg:mb-4 text-[15px]">
        ...
        <div className="relative container mx-auto bg-transparent max-w-screen-2lg  h-[90vh]">
          <div className="relative flex  sm:w-full h-full justify-between">
            <div className="sm:w-[45%] lg:w-[40%] h-full ">
            ...
            <div className="hidden sm:flex flex-col sm:w-[45%] lg:w-[42%] pt-10 h-full bg-transparent">
