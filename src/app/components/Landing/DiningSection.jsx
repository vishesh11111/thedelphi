      ...
      <div className="relative z-10  mx-auto ">
        <div className="flex flex-wrap items-center justify-between">
              ...
              <div className="absolute inset-0 font-serif flex items-center justify-center text-[170px] lg:text-[300px] font-bold italic text-white opacity-80 ">
                ...
                >
                  <motion.div
                    ...
                    initial={isVisibleSection && { opacity: 0, x: 0 }}
                    animate={isVisibleSection && { opacity: 1 }}
                  >
                    <motion.span
                      className={`letter1 ${
                        isVisibleSection && "animate-fade-up"
                      } text-black top outline-black fade-in top visible`}
                    >
                      D
                    </motion.span>
                    <motion.span
                      className={`letter1 {isVisibleSection && "animate-fade-up"} top text-black outline-black visible fade-in`}
                      initial={isVisibleSection && { x: 0 }}
                      animate={
                        isVisibleSection && {
                          x: [-50, 0, 50, 0],
                    ...
                    <motion.span
                      className={`${
                        isVisibleSection && "animate-fade-up"
                      } text-transparent top visible fade-in`}
                      initial={isVisibleSection && { x: 0 }}
                      animate={
                        isVisibleSection && {
                          x: [-50, 0, 50, 0],
                    ...
                    <motion.span
                      className={`${
                        isVisibleSection && "animate-fade-up"
                      } text-transparent  top visible outline-white fade-in`}
                      initial={isVisibleSection && { x: 0 }}
                      animate={
                        isVisibleSection && {
                          x: [-50, 0, 50, 0],
                    ...
                    <motion.span
                      className={`letter2 ${
                        isVisibleSection & "animate-fade-up"
                      } top text-transparent outline-white visible fade-in`}
                      initial={isVisibleSection && { x: 0 }}
                      animate={
                        isVisibleSection && {
                          x: [-50, 0, 50, 0],
                    ...
                    <motion.span
                      className={`${
                        isVisibleSection && "animate-fade-up"
                      }top visible text-black outline-white fade-in`}
                      initial={isVisibleSection && { x: 0 }}
                      animate={
                        isVisibleSection && {
                          x: [-50, 0, 50, 0],
          ...
          <div className="absolute w-full lg:w-[30%] pl-16 top-[80%] text-black left-0 z-[999]">
            <h2
              className={`uppercase text-lg lg:text-xl mb-4 font-serif ${
            ...
            <p
              className={`text-base lg:text-lg mb-6 fade-down ${
                isVisibleSection && "animate-fade-up4s"
              }`}
            >
